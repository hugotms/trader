...
| `DAYS_FMA`          | Specify the number of days looked at to calculate fast weighted moving average       | no      | 5     |
| `DAYS_MMA`          | Specify the number of days looked at to calculate middle weighted moving average       | no      | 25     |
| `DAYS_SMA`          | Specify the number of days looked at to calculate slow weighted moving average       | no      | 100     |
