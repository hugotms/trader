...
| `WINDOW_SIZE_FMA`          | Specify the number of units looked at to calculate fast weighted moving average       | no      | 5     |
| `WINDOW_SIZE_MMA`          | Specify the number of units looked at to calculate middle weighted moving average       | no      | 25     |
